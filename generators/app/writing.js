...
module.exports = function () {
  ...
  if (props.installBootstrap) {
    this.fs.copy(this.templatePath('src/scss/0-settings/_variables-bootstrap.scss'), 'src/scss/0-settings/_variables.scss');
    mkdirp(path.join(destPath, 'src/scss/3-generic'));
    mkdirp(path.join(destPath, 'src/scss/4-elements'));
    this.fs.copy(this.templatePath('src/scss/main-bootstrap.scss'), 'src/scss/main.scss');
  }
  else{
    this.fs.copy(this.templatePath('src/scss/0-settings/_variables.scss'), 'src/scss/0-settings/_variables.scss');
    this.fs.copy(this.templatePath('src/scss/3-generic/**/*.*'), 'src/scss/3-generic/');
    this.fs.copy(this.templatePath('src/scss/4-elements/**/*.*'), 'src/scss/4-elements/');
  ...
  mkdirp(path.join(destPath, 'src/scss/5-vendor'));
